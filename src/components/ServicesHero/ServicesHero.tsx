...
export const ServicesHero = () => {
  ...
  const stats = [
    ...
    { icon: <Users className="w-5 h-5" />, value: "24/7", label: "Atención" },
    { icon: <Award className="w-5 h-5" />, value: "100%", label: "Confianza" },
  ];
  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 px-6 max-w-5xl mx-auto">
        ...
        >
          <span className="block animate-fade-in-up" style={{ animationDelay: '0.5s' }}>Nuestros</span>
